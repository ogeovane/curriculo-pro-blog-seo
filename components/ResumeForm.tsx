    ...
    <div className="space-y-8 pb-20">
      ...
      <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h3 className="text-lg font-bold">{t('builder.form.personal_info')}</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-500 uppercase">{t('builder.form.full_name')}</label>
            <input
              type="text"
              value={data.name}
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-500 uppercase">{t('builder.form.desired_role')}</label>
            <input
              type="text"
              value={data.role}
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-500 uppercase">{t('builder.form.email')}</label>
            <input
              type="email"
              value={data.email}
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-500 uppercase">{t('builder.form.phone')}</label>
            <input
              type="text"
              value={data.phone}
        ...
        <div className="mt-4 space-y-1">
          <label className="text-xs font-semibold text-gray-500 uppercase">{t('builder.form.summary')}</label>
          <textarea
            rows={4}
            value={data.summary}
            onChange={(e) => updateField('summary', e.target.value)}
            className="w-full p-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
            placeholder={t('builder.form.summary_placeholder')}
          />
        </div>
      </section>
      ...
      <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-bold">{t('builder.form.experience')}</h3>
          </div>
          <button
        ...
        <div className="space-y-6">
          {data.experiences.map((exp) => (
            <div key={exp.id} className="p-4 border border-gray-100 rounded-lg relative group">
              ...
              <textarea
                placeholder={t('builder.form.description')}
                rows={3}
      ...
      <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-bold">{t('builder.form.education')}</h3>
          </div>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-bold">{t('builder.form.skills')}</h3>
          </div>
          <textarea
            placeholder={t('builder.form.skills_placeholder')}
        ...
        <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-bold">{t('builder.form.languages')}</h3>
          </div>
          <textarea
            placeholder={t('builder.form.languages_placeholder')}
